...
by krav and comotion, Fall 2011.

Ultralite distributed DNS syndication.

PussyDNS sprung from the wish to have a resilient and scalable DNS infrastructure.
...
3. git clone git://github.com/comotion/pussydns /etc/pussydns
4. clone your and my domain git repos into /etc/dns/zones/<repo>
5. check that everything works by running /pussydns/pussydns.sh in /etc/dns
6. cp pussydns.cron /etc/cron.d # to periodically sync and validate repos
